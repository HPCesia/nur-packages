...
| `kelivo` | [kelivo](https://github.com/Chevey339/kelivo) | `1.2.7` | [AGPL-3.0-only](https://spdx.org/licenses/AGPL-3.0-only.html) | LLM chat client |
...
| `navibeat` | [navibeat](https://navibeat.app/linux) | `1.0.13` | **Unfree** | Navidrome and Subsonic music client for Linux |
...
| `steelix` | [steelix](https://github.com/mattwparas/helix) | `0-unstable-2026-09-17` | [MPL-2.0](https://spdx.org/licenses/MPL-2.0.html) | Helix editor with Steel (Scheme) scripting support |
